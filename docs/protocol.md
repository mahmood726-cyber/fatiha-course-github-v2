        # Fatiha Course Github V2: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/fatiha-course-github-v2.git

        ## Objective

        Fatiha Course v2 is an evidence synthesis methods course with 25 modules in English and French, covering meta-analysis, network synthesis, and evidence grading.
        ...
        - Code: https://github.com/mahmood726-cyber/fatiha-course-github-v2.git
